...
CREATE TABLE IF NOT EXISTS summaries(
             ...
             -- Summary of the item. Either a user-generated transaction, or a protocol event 
             -- (such as validator rewards, transaction fee rewards, finalization rewards, foundation rewards in payday blocks), or a chain-update transaction (create PLT transaction).
